...
app.use('/crmWebPage/public/resources', express.static(path.join(__dirname, 'public/resources')));
app.use('/crmWebPage/public/images', express.static(path.join(__dirname, 'public/images')));
