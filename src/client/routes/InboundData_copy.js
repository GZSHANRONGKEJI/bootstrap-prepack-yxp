...
class InboundData_copy extends Component {
                        ...
                        <Col xs={ 12 }
                            ...
                            <Tabs defaultActiveKey={ 1 }
                                ...
                                <Tab title="问题记录"
                                     ...
                                     key={ 1 }
                                     params={ this.props.params }>
                                    <CrmPanelGroup header="问题记录" params={ this.props.params }>
                                        <Row params={ this.props.params }>
                                            <Col xs={ 12 }
                                                 md={ 12 }
                                                 sm={ 12 }
                                                 lg={ 12 }
                                                 params={ this.props.params }>
                                                <CrmInputForm params={ this.props.params }>
                                                    <CrmLabel label="选择问题类别"
                                                              labelClassName="col-xs-2"
                                                              params={ this.props.params }></CrmLabel>
                                                    <CrmInputDiv className="col-xs-4" params={ this.props.params }>
                                                        <Sdropdown params={ this.props.params }></Sdropdown>
                                                    </CrmInputDiv>
                                                    <CrmLabel label="问题处理方式"
                                                              labelClassName="col-xs-2"
                                                              params={ this.props.params }></CrmLabel>
                                                    <CrmInputDiv className="col-xs-4" params={ this.props.params }>
                                                        <Sdropdown params={ this.props.params }></Sdropdown>
                                            ...
                                            <Col xs={ 12 }
                                                ...
                                                <CrmInputForm params={ this.props.params }>
                                                    <CrmLabel label="问题描述"
                                                              labelClassName="col-xs-2"
                                                              params={ this.props.params }></CrmLabel>
                                                    <CrmInputDiv className="col-xs-10" params={ this.props.params }>
                                                        <Textarea params={ this.props.params }></Textarea>
                                                    </CrmInputDiv>
                                                </CrmInputForm>
                                            </Col>
                                        </Row>
                                    ...
                                    <SalesFollowTask header="问题反馈" params={ this.props.params }></SalesFollowTask>
                                </Tab>
                                <Tab title="通话记录"
                                     eventKey={ 2 }
                                     key={ 2 }
                                    ...
                                    <Row params={ this.props.params }>
                                        <Col xs={ 12 }
                                            ...
                                            <Table striped={ true }
                                                ...
                                                <QuestionHistoryListRow params={ this.props.params }></QuestionHistoryListRow>
                                            </Table>
                                        </Col>
                                    </Row>
                                </Tab>
...
export default InboundData_copy;
